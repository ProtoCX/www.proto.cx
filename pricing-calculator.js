...
$(document).ready(function () {
  ...
  function updatePriceBreakdown() {
    ...
    if (
      $('input[name="proGPT"]').prop('checked') &&
      $('input[name="proAnalytics"]').prop('checked')
    ) {
      selectedAddonsSpan.text('proGPT and proAnalytics add-ons.')
    } else if ($('input[name="proGPT"]').prop('checked')) {
      selectedAddonsSpan.text('proGPT add-on.')
    } else if ($('input[name="proAnalytics"]').prop('checked')) {
      selectedAddonsSpan.text('proAnalytics add-on.')
    } else {
      selectedAddonsSpan.text('') // Reset the text if neither is selected
    }
